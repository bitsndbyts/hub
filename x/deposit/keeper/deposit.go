...
func (k Keeper) Add(ctx sdk.Context, address sdk.AccAddress, coins sdk.Coins) (err error) {
...
func (k Keeper) ReceiveFromAccountToDeposit(ctx sdk.Context, from, to sdk.AccAddress, coins sdk.Coins) error {
