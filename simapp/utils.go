...
//
//		bechPKA, _ := sdk.Bech32ifyPubKey(sdk.Bech32PubKeyTypeAccPub, pubKeyA)
//		bechPKB, _ := sdk.Bech32ifyPubKey(sdk.Bech32PubKeyTypeAccPub, pubKeyB)
